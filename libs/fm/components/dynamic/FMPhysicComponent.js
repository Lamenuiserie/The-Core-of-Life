...
function fmPhysicComponent(owner) {
    ...
    that.boundingBox = fmRectangle(0, 0, renderer.getWidth(), renderer.getHeight());
    that.maxXVelocity = 0;
    that.maxYVelocity = 0;
    that.xVelocity = 0;
    that.yVelocity = 0;
    ...
    that.setBoundingBox = function (width, height) {
        that.boundingBox = fmRectangle(0, 0, width, height);
    };
    ...
    */
    that.update = function (game) {
        that.boundingBox.width = renderer.getWidth();
        that.boundingBox.height = renderer.getHeight();
