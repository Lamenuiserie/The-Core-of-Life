...
function fmSpriteRendererComponent(owner) {
    ...
    */
    ...
    that.play = function (animName) {
        ...
        linePosition = Math.floor(columnPosition / image.naturalWidth) * frameHeight;
        if (columnPosition >= image.naturalWidth) {
            linePosition = Math.floor(columnPosition / image.naturalWidth) * frameHeight;
            columnPosition = (columnPosition % image.naturalWidth);
        }
    };
